...
<section id="remove" class="parallax-section">
	<div class="container">
		<div class="row">
		<center><h1 class="heading color-black"> CUSTOMER REMOVE</h1></center>
...
$result3 = $conn->query($sql2);
			...
			if ($result3->num_rows > 0) {
				...
				while ($row = $result3->fetch_assoc()) {
					...
					$remove = "SELECT * FROM `login` WHERE log_id='$log_id'";
					$remove_result = mysqli_query($conn, $remove);
					$rsltcheck = mysqli_num_rows($remove_result);
					$row2 = mysqli_fetch_array($remove_result);
					if($rsltcheck == 1){
		...
		?>
                                <tr>
									...
									<td>
                                    <a href="delete-c.php?log_id=<?php echo $row['log_id'];?>" >
...
<section id="re-add" class="parallax-section">
	<div class="container">
		<div class="row">
		<center><h1 class="heading color-black"> CUSTOMER RE-ADD</h1></center>
...
$result3 = $conn->query($sql2);
		...
		?>
                                <tr>
									...
									<td>
                                    <a href="re-add-c.php?log_id=<?php echo $row3['log_id'];?>" >
