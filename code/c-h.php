...
include("config.php");
include("session.php");
$sql = "SELECT * FROM car order by sntscore DESC";
                ...
                <div class="col-md-4">
                  <div class="car-wrap rounded ftco-animate">
                    ...
                    <div class="text">
                      ...
                      <p class="d-flex mb-0 d-block">
                      <form method="post" action="booking.php"><input type="submit" class="btn btn-primary py-2 mr-1" name="submit" id="sbd" value="Book Now">
                        <input type="hidden" name="cid" value="<?php echo $row['car_id'] ?>">
                      </form>
                      </p>
                      <p class="d-flex mb-0 d-block">
