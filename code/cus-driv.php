...
include("config.php");
include("session.php");
$sql = "SELECT driver.*,login.statuss FROM driver,login where driver.log_id=login.log_id and login.statuss='1'";
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="" class="nav-item nav-link">Drivers</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="c-h.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Cars <i class="ion-ios-arrow-forward"></i></span></p>
    	...
    	<div class="container">
			...
			if ($result->num_rows > 0) {
				...
				while ($row = $result->fetch_assoc()) {
                    if($row['statuss']==1 && $row['availability']==1){
						$day=date("Y-m-d");
						
						$driver=$row['driver_id'];
						$book="SELECT * FROM `dbook` WHERE `driver_id`=$driver";
						$br=$conn->query($book);
						if ($br->num_rows > 0) {
		...
		?>
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(images/<?php echo $row['dim']; ?>);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href=""><?php echo strtoupper($row['fname']); ?></a></h2>
...
<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					...
    					<div class="text">
    						<h2 class="mb-0"><a href="car-single.html"><?php echo strtoupper($row['fname']); ?></a></h2>
    						<div class="d-flex mb-3">
	    						<!-- <span class="cat"><?php echo strtoupper($row['company']); ?></span> -->
	    						<p class="price ml-auto"><?php echo ""; ?>Rs <span>/day</span></p>
