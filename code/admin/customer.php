...
<body class="animsition">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <form action="" method="post">
                                                    <input type="hidden" id="cus" name="cus" value="<?php echo $row['cus_id']; ?>">
                                                    ...
                                                    <form action="" method="post">
                                                    <input type="hidden" id="cus2" name="cus2" value="<?php echo $row['cus_id']; ?>">
  ...
  if(isset($_POST['block'])){
    $id = $_POST['cus'];
    $select_user = "SELECT `log_id` FROM `customer` WHERE `cus_id` = '$id'";
