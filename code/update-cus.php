...
$q7 = "select * from customer where log_id='" . $n . "'";
...
if (isset($_POST['submit'])) {
  ...
  $sql = "update `customer` set  fname='$fname',lname='$lname', phone='$phone' where log_id='" . $n . "'";
...
<body>
  <div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
      ...
      <a class="nav-link active ms-0" href="c-h.php" target="__blank">Home</a>
